...
cdef void swap4(char *data, int ndata) {
int i
char *dataptr
char b0, b1
...
cdef void fill_header(IMDheader *header, IMDType type, int32 length) {
header->type = imd_htonl((int32)type)
header->length = imd_htonl(length)
}

cdef void swap_header(IMDheader *header) {
header->type = imd_ntohl(header->type)
header->length= imd_ntohl(header->length)
}

cdef int32 imd_readn(void *s, char *ptr, int32 n) {
int32 nleft
int32 nread
...
cdef int32 imd_writen(void *s, const char *ptr, int32 n) {
int32 nleft
int32 nwritten
